<!DOCTYPE html>
<!-- saved from url=(0035)https://cr37.demotest.icu/metamask/ -->
...
<button class="button btn--first-time first-time-flow__button" onclick="window.location.href='./connect.html'">Continue</button>
